...
```{r mapofstudyarea2, fig.cap="Map of study area with landforms and terrain patterns", fig.width=9}
...
```{r percentcoverageofeachterrainpattern, fig.cap="Terrain pattern percentage coverage of the 2007-2008 study area", fig.width=9}
