...
```{r methodschematic, fig.cap="Schematic of two approaches used to investigate boundary effects in the Roxby duenfields, South Australia. A: the straight-line distances from sites to the boundaries of the terrain patterns that they are contained it was measured. B: the number of sites per square kilometer was measured in a series of buffer areas, an example of a buffer area is indicated here by a grey region at the exterior of the terrain pattern area.", fig.width=fig_width_two_cols}
