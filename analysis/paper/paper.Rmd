...
odx_polygons <- 
  filter(odx_polygons,  GREGLANDF %in% c("A4", "Czs4", "Q4", "K4", "Czs5", "Q5", "Q6"))
...
odx_polygons_coords <- apply(odx_polygons, 1,  function(i) st_coordinates(i$geometry))
...
```{r maxmindistancetoboundary, fig.cap="Left: Distributions of distances of archaeological sites to terrain pattern bounaries. Right: Distributions of ratios of observed distance of site to terrain pattern boundary and the maximum possible distance to boundary for each terrain pattern. Distance is shown on the vertical axis with a logarithmic scale. Data points show distance values for individual sites.", fig.width=fig_width_two_cols}
